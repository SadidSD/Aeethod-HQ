...
const cleanDesignRoom = `  // --- DESIGN ROOM (Luxury All-White Architectural L-Shaped Boss Desk & Studio PC) ---
...
console.log('Successfully reverted Design Room to clean state!');
